...
> > > > از دفعات بعد برای استفاده از بمبر فقط از قدم چهارم به بعد را اجرا کنید، یعنی از دستور cd برای رفتن به پوشه بمبر و از دستور پایتون برای اجرا استفاده کنید، برای تمام ابزارها در لینوکس صادق است
